...
const RemoveCountry = ({ removeHandler }) => {
  ...
  return (
    <div className="country-remove">
      {list.map((item, index) => {
        ...
        return (
          <div
            className="country-remove-card"
            key={index}
            onClick={() => removeHandler(item)}
          >
            <div className="country-name">{obj.name}</div>
            <div className="country-capital">{obj.capital}</div>
            <div className="country-timezone">{timezone}</div>
            <div className="country-remove-cross">X</div>
          </div>
        );
      })}
    </div>
